...
def register(
    ...
    # target_image_shape = (1080)
    # target_label_shape = (200, 3)

    with open(model_config_path, "r") as f:
        yams = yaml.safe_load(f)["dataset"]
        target_image_shape = yams["fixed_image_shape"]
        target_label_shape = yams["moving_image_shape"]
        dataset_dirs = yams[dataset_type]["dir"]
    ...
    for dataset_dir in dataset_dirs:
        ...
        print(f"{dataset_dir}/fixed_images.h5")
        ...
        for problem in tqdm(problems):
            ...
            ddf_output, pred_fixed_image, model = unwrapped_predict( ### OK THIS IS THE CULPRIT
                batched_fixed_image,
            ...
            ncc_scores[dataset_name][problem] = calculate_ncc(
                pred_fixed_image.squeeze(axis = 0), #### BRIAN HMMMMMM
                batched_fixed_image.numpy().squeeze(axis = 0)
            )
